    ...
    setPosts(prev => {
      ...
      if (editingPost) {
        ...
        updatedPosts = prev.map(post => 
          post.id === editingPost.id ? {...enhancedPost, views: post.views, applications: post.applications, engagementRate: post.engagementRate} : post
        )
      } else {
  ...
  return (
    <>
      ...
      <div className="posts-container">
              ...
              <div className="analytics-header">
                ...
                <div className="analytics-grid">
                  ...
                  <div className="stat-item">
                    <Users />
                    <div className="stat-info">
                      <span className="stat-value">{post.applications?.length || 0}</span>
                  ...
                  <div className="stat-item">
                    <BarChart2 />
                    <div className="stat-info">
                      <span className="stat-value">{post.engagementRate || '0%'}</span>
        ...
        <Modal visible={!!deleteConfirmId} onClose={() => setDeleteConfirmId(null)}>
          <Modal.Title>Confirm Delete</Modal.Title>
          <Modal.Content>
            Are you sure you want to delete this post? This action cannot be undone.
          </Modal.Content>
          <Modal.Action passive onClick={() => setDeleteConfirmId(null)}>Cancel</Modal.Action>
          <Modal.Action 
            loading={isDeleting}
