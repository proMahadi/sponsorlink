...
export default function Signup({User, setUser, isAuthenticated, setIsAuthenticated}) {
            ...
            <div className='auth-container'>
                ...
                <div className='login-prompt'>
                    <div style={{ color: error ? 'red' : 'inherit' }}>
                        {error || 'Already a member?'} <span style={{ color: error ? 'black' : '' }} className='login-link' onClick={() => navigate('/login')}> {`Log in ->`}</span>
                    </div>
                    <subtitle>
                        By proceeding, you agree to the <span>Terms and Conditions</span> and <span>Privacy Policy</span>
                    </subtitle>
                </div>
            </div>    
        </div>
