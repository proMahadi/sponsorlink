...
export default function ListingDetails() {
  ...
  useEffect(() => {
    ...
    setIsApplied(
      applications?.some((app) => app.listing.name === selectedListing.name)
    )
    const savedListings = getStorageItem(STORAGE_KEYS.SAVED_LISTINGS)
    setIsSaved(
      savedListings.some((saved) => saved.name === selectedListing.name)
    )
  ...
  const handleToggleSaveListing = useCallback(() => {
    ...
    const isAlreadySaved = savedListings.some(
      (saved) => saved.name === selectedListing.name
    )
            ...
            <div className="details-header">
              <Avatar
                ...
                src={
                  ...
                  `https://randomuser.me/api/portraits/men/${selectedListing.id}.jpg`
                }
              />
              <div className="details-title">
                ...
                <div className="details-subtitle">
                  <span className="role">
                    {selectedListing.opportunity_type}
                  </span>
                ...
                <>
                  <div className="form-buttons">
                    <button
                      ...
                      title={
                        !applicationMessage.trim()
                          ? 'Please Enter your Application message'
                          : ''
                      }
                      style={{
