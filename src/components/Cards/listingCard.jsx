    ...
    <div className="listing-card" onClick={() => showDetails && handleClick()}>
      <div className="listing-header">
        <div className="listing-strap">
          <div onClick={(e) => {
            ...
            <div className="listing-img">
              <img src={listing.image} alt={`${listing.name}'s profile`} />
            </div>
        ...
        <div className="listing-options" ref={optionsRef}>
          <div className="listing-score" style={{ color: getColor(listing.score) }}>
            {listing.score}
          </div>
          <div onClick={(e) => {
            e.stopPropagation();
            ...
            <div className="options-popup">
              {showApply && (
                ...
                >
                  ...
                  <MessageCircle size={17} fill={isAlreadyApplied() ? 'black' : 'none'} />
                </div>
              )}
              {showSave && (
              ...
              {showRemove && (
                <div id="removeCard" className="option" onClick={(e) => {
                  e.stopPropagation();
                  setIsOptionsVisible(false);
                  setTimeout(() => {
                    onRemove();
      ...
      {listing.description + " This is a description of the listing. I have added some more text to make it longer. Enjoy the prototype Explore page!"}
      </div>
